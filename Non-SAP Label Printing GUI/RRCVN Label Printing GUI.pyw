...
LABELS = [
    ...
    {
        "no": 6,
        "title": "RRC2020-DR Rear\n Label",
        "description": "Prints Dräger manufacturer label with revision number and \nexpiration date.",
        "script": "bartender_print-rear-label_GUI.py",
        "image": "label_rear.png",
    },
    {
        "no": 7,
        "title": "Stocktaking\nLabel",
