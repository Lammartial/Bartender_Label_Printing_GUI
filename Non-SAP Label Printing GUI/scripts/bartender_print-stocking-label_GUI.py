...
# GUI APP
# =========================
class StockingLabelForm(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Print Form - Stocking Label")
    ...
    def execute_print(self):
        ...
        if success:
            messagebox.showinfo("Success", f"Sent {copies} copy/copies of Stocking Label to {PRINTERNAME}.")
            self.destroy()
        else:
            messagebox.showerror("Print Failed", f"An error occurred while generating the print file:\n\n{msg}")

if __name__ == "__main__":
    app = StockingLabelForm()
    app.mainloop()