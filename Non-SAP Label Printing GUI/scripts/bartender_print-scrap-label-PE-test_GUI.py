...
LABELFILE   = "Scrap label-PE test.BTW"
...
# GUI APP
# =========================
class ScrapLabelPETestForm(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Print Form - Scrap Label (PE Test)")
    ...
    def build_ui(self):
        ...
        tk.Label(
            header,
            text="Print - Scrap Label (PE Test)",
    ...
    def execute_print(self):
        ...
        if success:
            messagebox.showinfo("Success", f"Sent {copies} copy/copies of Scrap Label (PE Test) to {PRINTERNAME}.")
            self.destroy()
        else:
            messagebox.showerror("Print Failed", f"An error occurred while generating the print file:\n\n{msg}")

if __name__ == "__main__":
    app = ScrapLabelPETestForm()
    app.mainloop()