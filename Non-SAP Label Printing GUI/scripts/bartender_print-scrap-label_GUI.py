...
# GUI APP
# =========================
class ScrapLabelForm(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Print Form - Scrap Label")
    ...
    def execute_print(self):
        ...
        if success:
            messagebox.showinfo("Success", f"Sent {copies} copy/copies of Scrap Label to {PRINTERNAME}.")
            self.destroy()
        else:
